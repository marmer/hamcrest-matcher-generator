...
public class ReflectionPotentialBeanClassFinderTest {
    ...
    @Test
    public void testFindClasses_FullQualifiedClassNameGiven_ShouldReturnOnlyTheRelatedClass()
        throws Exception {
        // Preparation
    ...
    @Test
    public void testFindClasses_NotExistingPackageGiven_ShouldNotReturnNoClasses()
        throws Exception {
        // Preparation
    ...
    @Test
    public void testFindClasses_MultipleClassesGiven_ShouldReturnAllRelatedClasses()
        throws Exception {
        // Preparation
