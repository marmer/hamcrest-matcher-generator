...
public class MatchersMojoJDK8AndNewHamcrestSystemTest {
	@Rule
	public TestProjectResource testproject = new TestProjectResource("testprojectJava8AndCurrentHamcrestVersion");
	...
	@Test
	public void testTestStillWorksAfterPlugin() throws Exception {
