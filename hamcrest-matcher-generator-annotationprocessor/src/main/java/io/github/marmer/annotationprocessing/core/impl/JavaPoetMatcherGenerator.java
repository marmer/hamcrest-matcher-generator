...
public class JavaPoetMatcherGenerator/* implements MatcherGenerator */ {
    // TODO: marmer 17.06.2021 This is a cheat sheet. Remove me!
//
...
//        return JavaFile.builder(packageFrom(descriptor), matcherTypeFor(descriptor).build()).skipJavaLangImports(true)
//            .indent("    ").build();
//    }
//
...
//    }
//
//    private MethodSpec propertyMatcherMethodFor(final PropertyDescriptor property,
//        final MatcherBaseDescriptor descriptor) {
...
//            .addStatement("$L.with($S, $T.equalTo(value))", INNER_MATCHER_FIELD_NAME, property.getProperty(),
//                Matchers.class)
...
//        return Arrays
//            .asList(describeToMethod(), matchesSafelyMathod(descriptor), describeMismatchSafelyMethod(descriptor));
//    }
//
...
//        final ParameterizedTypeName fieldType = ParameterizedTypeName
//            .get(ClassName.get(BeanPropertyMatcher.class), getClassNameFor(descriptor.getBase()));
...
//    }
//
//    private MatcherConfiguration.GenerationConfiguration.PackageConfiguration getGenerationPackageConfigurationFrom(
//        final MatcherBaseDescriptor descriptor) {
//        return getGenerationConfigurationFrom(descriptor).packageConfig();
//    }
//
//    private MatcherConfiguration.GenerationConfiguration getGenerationConfigurationFrom(
//        final MatcherBaseDescriptor descriptor) {
